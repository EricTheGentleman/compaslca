...
llm_elements = Path("data/pipeline/step_02_material_matching/step_02b_bookkeeping/z_test_OEKOBAUDAT/Elements")
llm_target_layers = Path("data/pipeline/step_02_material_matching/step_02b_bookkeeping/z_test_OEKOBAUDAT/Target_Layers")
...
output_base_dir = Path("data/pipeline/step_03_lca_calculation/step_03a_append_specific_indicators/z_test_Oekobaudat")
